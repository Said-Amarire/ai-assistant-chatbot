...
function ai_assistant_chatbot_settings_page() {
    ...
    ?>
    <div class="wrap">
        <h1>AI Assistant ChatBot — Full Control Settings</h1>
        <p>All options can be edited here. Changes reflect immediately on the frontend.</p>
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tr>
                    <th><label for="bot_name">Bot Name</label></th>
                ...
                <tr>
                    <th><label for="warning_message">Warning Message (English)</label></th>
                ...
                <tr>
                    <th><label for="send_button_text">Send Button Text</label></th>
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        ...
                        <span>Check to enable new message sound</span>
                    </td>
                </tr>
                <tr>
                    <th>Sound URL</th>
                    <td>
                        ...
                        <p class="description">Enter full URL to the notification sound.</p>
                    </td>
                </tr>
            </table>
            ...
            <h2>Appearance</h2>
            <table class="form-table">
                <tr><th>Primary Color</th><td><input type="color" name="ai_assistant_chatbot_options[primary_color]" value="<?php echo esc_attr($opts['primary_color']); ?>"></td></tr>
                <tr><th>Secondary Color</th><td><input type="color" name="ai_assistant_chatbot_options[secondary_color]" value="<?php echo esc_attr($opts['secondary_color']); ?>"></td></tr>
                <tr><th>Bot Message Background</th><td><input type="color" name="ai_assistant_chatbot_options[bot_message_bg]" value="<?php echo esc_attr($opts['bot_message_bg']); ?>"></td></tr>
                <tr><th>User Icon</th><td><input type="text" name="ai_assistant_chatbot_options[user_icon]" value="<?php echo esc_attr($opts['user_icon']); ?>"></td></tr>
                <tr><th>Bot Icon</th><td><input type="text" name="ai_assistant_chatbot_options[bot_icon]" value="<?php echo esc_attr($opts['bot_icon']); ?>"></td></tr>
            </table>

            <h2>Quick Replies</h2>
            <table class="form-table">
                <tr>
                    <th>Quick Buttons (comma-separated)</th>
